...
struct Day_3 {
    static func p1(input: [String]) -> Int {
        ...
        for i in 1...input.count {
            ...
            // lines to compare
            let topLine = i>=2 ? input[i-2] : ""
            let centreLine = input[i-1]
            let bottomLine = i<input.count ? input[i] : ""
            ...
            for match in matches {
                ...
                let bottomLineCheck = i<input.count ? bottomLine[newRange].contains(/[^\w\s\.]/) : false
    ...
    static func p2(input: [String]) -> Int {
        ...
        for i in 1...input.count {
            ...
            for match in matches {
                ...
                let bottomLineNumbers = i<input.count ? bottomLine[newRange].ranges(of: /\d+/) : []
